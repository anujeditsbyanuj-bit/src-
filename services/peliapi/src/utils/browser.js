...
async function scrapeWithPage(url, scraperFn, opts = {}) {
  ...
  for (let attempt = 0; attempt <= maxRetries; attempt++) {
    ...
    try {
      ...
      releaseSlot();
      // If the browser instance is corrupted, kill and retry
      if (attempt < maxRetries && (
        ...
        console.log(`[browser] Browser corrupted (${err.message}), relaunching...`);
