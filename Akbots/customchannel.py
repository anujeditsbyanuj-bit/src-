...
USAGE_TXT = (
    f"<blockquote>{E_WARN} <b>ᴜsᴀɢᴇ:</b> <code>/set_channel_id -100xxxxxxxxxx</code>\n"
    f"<b>ᴇxᴀᴍᴘʟᴇ:</b> <code>/set_channel_id -1001234567890</code>\n\n"
    f"<b>ɴᴏᴛᴇ:</b> The ID must start with <code>-100</code> and you must make me "
...
NOT_SET_TXT = (
    f"<blockquote>{E_CROSS} <b>ɴᴏ ᴄᴜsᴛᴏᴍ ᴄʜᴀɴɴᴇʟ sᴇᴛ!</b>\n\n"
...
async def set_channel_command(client: Client, message: Message):
    ...
    await message.reply_text(
        f"<blockquote>{E_CHECK} <b>ᴄᴜsᴛᴏᴍ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋᴇᴅ!</b>\n\n"
        f"<b>ᴄʜᴀɴɴᴇʟ ɴᴀᴍᴇ:</b> {channel_title}{username_line}\n"
        f"<b>ᴄʜᴀɴɴᴇʟ ɪᴅ:</b> <code>{chat_id}</code>\n\n"
        f"All downloaded files will now also be sent here.\n"
        f"<b>ᴛᴏᴛᴀʟ ʟɪɴᴋᴇᴅ ᴄʜᴀɴɴᴇʟs:</b> {total}\n\n"
        f"<b>ɴᴏᴛᴇ:</b> Files won't be auto-deleted from channel/group.\n\n"
...
async def del_channel_command(client: Client, message: Message):
    ...
    if len(message.command) < 2:
        ...
        return await message.reply_text(
            f"<blockquote>{E_CHECK} <b>ᴀʟʟ ᴄᴜsᴛᴏᴍ ᴄʜᴀɴɴᴇʟs ʀᴇᴍᴏᴠᴇᴅ</b>\n\n"
    ...
    await message.reply_text(
        f"<blockquote>{E_CHECK} <b>ᴄʜᴀɴɴᴇʟ ʀᴇᴍᴏᴠᴇᴅ</b>\n\n"
