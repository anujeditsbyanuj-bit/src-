...
HELP_TXT = (
    ...
    f"{E_ARROW} Simply <b>sᴇɴᴅ ᴀɴʏ ᴛᴇʟᴇɢʀᴀᴍ ᴘᴏsᴛ ʟɪɴᴋ</b> (public or private).\n"
    f"{E_BATCH} For <b>ʙᴀᴛᴄʜ sᴀᴠɪɴɢ</b>: Send a link like <code>https://t.me/channel/100-110</code>\n"
    ...
    f"<blockquote>{E_ARROW} <b>/sᴛᴀʀᴛ</b> — Restart the bot &amp; view your quota</blockquote>\n"
    f"<blockquote>{E_ARROW} <b>/ʜᴇʟᴘ</b> — Show this detailed guide</blockquote>\n"
    f"<blockquote>{E_GEAR} <b>/sᴇᴛᴛɪɴɢs</b> — Open settings menu</blockquote>\n"
    f"<blockquote>{E_INFO} <b>/ᴄᴏᴍᴍᴀɴᴅs</b> — Quick command list</blockquote>\n\n"
    f"<blockquote>{E_LOCK} <b>/ʟᴏɢɪɴ</b> — Login with session string</blockquote>\n"
    f"<blockquote>{E_CROSS} <b>/ʟᴏɢᴏᴜᴛ</b> — Logout current session</blockquote>\n"
    f"<blockquote>{E_WARN} <b>/ᴄᴀɴᴄᴇʟ</b> — Cancel ongoing batch save</blockquote>\n\n"
    f"<blockquote>{E_DIAMOND} <b>/ᴍʏᴘʟᴀɴ</b> — View your plan status &amp; quota</blockquote>\n"
    f"<blockquote>{E_CROWN} <b>/ᴘʀᴇᴍɪᴜᴍ</b> — Premium plans &amp; benefits</blockquote>\n\n"
    f"<blockquote>{E_BOLT} <b>/sᴇᴛᴄʜᴀᴛ &ʟᴛ;ᴄʜᴀᴛ_ɪᴅ&ɢᴛ;</b> — Set dump chat</blockquote>\n"
    f"<blockquote>{E_CROSS} <b>/sᴇᴛᴄʜᴀᴛ ᴄʟᴇᴀʀ</b> — Remove dump chat</blockquote>\n\n"
    f"<blockquote>{E_BOLT} <b>/sᴇᴛ_ᴄʜᴀɴɴᴇʟ_ɪᴅ &ʟᴛ;ᴄʜᴀɴɴᴇʟ_ɪᴅ&ɢᴛ;</b> — Auto-send files to your channel/group</blockquote>\n"
    f"<blockquote>{E_CROSS} <b>/ᴅᴇʟ_ᴄʜᴀɴɴᴇʟ_ɪᴅ</b> — Remove custom channel</blockquote>\n\n"
    f"<blockquote>{E_PENCIL} <b>/sᴇᴛ_ᴄᴀᴘᴛɪᴏɴ &ʟᴛ;ᴛᴇxᴛ&ɢᴛ;</b> — Set custom caption</blockquote>\n"
    f"<blockquote>{E_INFO} <b>/sᴇᴇ_ᴄᴀᴘᴛɪᴏɴ</b> — Preview current caption</blockquote>\n"
    f"<blockquote>{E_CROSS} <b>/ᴅᴇʟ_ᴄᴀᴘᴛɪᴏɴ</b> — Remove custom caption</blockquote>\n\n"
    f"<blockquote>{E_IMAGE} <b>/sᴇᴛ_ᴛʜᴜᴍʙ</b> — Reply to photo to set custom thumbnail</blockquote>\n"
    f"<blockquote>{E_INFO} <b>/ᴠɪᴇᴡ_ᴛʜᴜᴍʙ</b> — Preview current thumbnail</blockquote>\n"
    f"<blockquote>{E_CROSS} <b>/ᴅᴇʟ_ᴛʜᴜᴍʙ</b> — Remove custom thumbnail</blockquote>\n\n"
    f"<blockquote>📤 <b>/ᴜᴘʟᴏᴀᴅ_ᴍᴏᴅᴇ</b> — Toggle Auto vs Always-Document uploads</blockquote>\n\n"
    f"<b>{E_TIP} Tips</b>\n"
