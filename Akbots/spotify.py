...
def _confirm_kb(session_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[
        make_button("✅ Start download", callback_data=f"spotifygo#{session_id}", style=_BS.SUCCESS if _BS else None),
        make_button("❌ Cancel", callback_data=f"spotifycancel#{session_id}", style=_BS.DANGER if _BS else None),
    ]])
