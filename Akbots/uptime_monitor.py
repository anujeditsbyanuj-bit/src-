...
def _menu_page(urls: dict, page: int = 1):
    ...
    buttons.append([make_button("➕ ᴀᴅᴅ ᴜʀʟ", callback_data="ut_add", style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)])
    buttons.append([
...
def _empty_menu():
    ...
    buttons = [
        [make_button("➕ ᴀᴅᴅ ᴜʀʟ", callback_data="ut_add", style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
