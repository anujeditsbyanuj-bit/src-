...
def _folder_confirm_kb(session_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[
        make_button("✅ Download all", callback_data=f"mffold#{session_id}", style=_BS.SUCCESS if _BS else None),
        make_button("❌ Cancel", callback_data=f"mffoldcancel#{session_id}", style=_BS.DANGER if _BS else None),
    ]])
