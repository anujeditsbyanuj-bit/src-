...
@Client.on_callback_query(filters.regex("^(cmd_list_btn|dump_chat_btn|thumb_btn|caption_btn|user_stats_btn|batch_limit_btn|upload_mode_btn|settings_back_btn|close_btn)$"))
