...
from Akbots.direct_utils import format_forward_caption
...
def get_start_buttons():
    if BUTTON_STYLE_SUPPORTED:
        ...
        return InlineKeyboardMarkup([
            ...
            [
                make_button(" 🎤 ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ", callback_data="vc#gen", style=S.PRIMARY),
            ],
            [
        ...
        return InlineKeyboardMarkup([
            ...
            [
                make_button(" 🎤 ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ", callback_data="vc#gen", style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None),
            ],
            [
