...
FEATURES_TXT = (
    ...
    f"<blockquote expandable><b>📥 Restricted Content Saving</b>\n"
    f"Save text/media/files from restricted channels • Batch mode • /login with your own account</blockquote>\n\n"
    f"<blockquote expandable><b>🌐 Universal Media Downloader</b>\n"
    ...
    f"<blockquote expandable><b>☁️ File Hosts &amp; Bypassers</b>\n"
    ...
    f"<blockquote expandable><b>🎬 Media Editing</b>\n"
    ...
    f"<blockquote expandable><b>🔁 Forwarding &amp; Automation</b>\n"
    ...
    f"<blockquote expandable><b>💎 Premium &amp; Admin</b>\n"
...
def _cmdlist_text(page: int) -> str:
    ...
    return (
        f"<b>📜 All Commands (A–Z)</b>  <i>· page {page + 1}/{total_pages}</i>\n\n"
        + "\n".join(lines)
    )
...
async def clone_footer(client: Client) -> str:
    ...
    try:
        ...
        return (
            f"\n<blockquote>⚡ <b>CREATED &amp; MANAGED BY</b> "
