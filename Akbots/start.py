...
ALL_COMMANDS = [
    ...
    ('akmanager', '🚀 1 Manager control panel'),
...
async def send_settings(client: Client, message: Message):
    ...
    if BUTTON_STYLE_SUPPORTED:
        ...
        buttons = InlineKeyboardMarkup([
            ...
            [make_button(" 📊 ᴜsᴀɢᴇ sᴛᴀᴛs ",         callback_data="user_stats_btn", icon_custom_emoji_id=ICON_STATS, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
            [make_button(" 🗑 ᴅᴜᴍᴘ ᴄʜᴀᴛ sᴇᴛᴛɪɴɢs ", callback_data="dump_chat_btn",  icon_custom_emoji_id=ICON_DELETE, style=ButtonStyle.DANGER if BUTTON_STYLE_SUPPORTED else None)],
            [make_button(" 🖼 ᴍᴀɴᴀɢᴇ ᴛʜᴜᴍʙɴᴀɪʟ ",  callback_data="thumb_btn",      icon_custom_emoji_id=ICON_IMAGE, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
            [make_button(" 📝 ᴇᴅɪᴛ ᴄᴀᴘᴛɪᴏɴ ",       callback_data="caption_btn",    icon_custom_emoji_id=ICON_EDIT, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
...
async def settings_panel(client, callback_query):
    ...
    if BUTTON_STYLE_SUPPORTED:
        ...
        buttons = InlineKeyboardMarkup([
            ...
            [make_button(" 🖼 ᴍᴀɴᴀɢᴇ ᴛʜᴜᴍʙɴᴀɪʟ ",  callback_data="thumb_btn",      icon_custom_emoji_id=ICON_IMAGE, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
            [make_button(" 📝 ᴇᴅɪᴛ ᴄᴀᴘᴛɪᴏɴ ",       callback_data="caption_btn",    icon_custom_emoji_id=ICON_EDIT, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)],
            [make_button(" ⬅️ ʜᴏᴍᴇ ",               callback_data="start_btn",      icon_custom_emoji_id=ICON_HOME, style=ButtonStyle.PRIMARY if BUTTON_STYLE_SUPPORTED else None)]
        ])
...
async def button_callbacks(client: Client, callback_query: CallbackQuery):
    ...
    elif data in ["user_stats_btn", "dump_chat_btn", "thumb_btn", "caption_btn"]:
