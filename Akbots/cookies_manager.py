...
def _panel_markup(mode: str = "root") -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup([
        [
            make_button("➕ ᴀᴅᴅ ᴄᴏᴏᴋɪᴇ", callback_data="ckpanel:add", style=_BS.SUCCESS if _BS else None),
            make_button("👁 ᴠɪᴇᴡ ᴄᴏᴏᴋɪᴇs", callback_data="ckpanel:view", style=_BS.SUCCESS if _BS else None),
        ],
