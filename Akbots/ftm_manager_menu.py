...
def _ak_manager_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        ...
        [make_button("🖋 ᴄᴀᴘᴛɪᴏɴ", callback_data="caption_btn", style=_BS.SUCCESS if _BS else None),
         make_button("🗃 ᴍᴏɴɢᴏᴅʙ", callback_data="database_btn", style=_BS.SUCCESS if _BS else None)],
        [make_button("🕵️ ғɪʟᴛᴇʀs", callback_data="ak_filters", style=_BS.PRIMARY if _BS else None),
         make_button("🔘 ʙᴜᴛᴛᴏɴ", callback_data="ak_button", style=_BS.SUCCESS if _BS else None)],
...
def _bots_menu() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([
        [make_button("➕ ᴀᴅᴅ ʙᴏᴛ", callback_data="ak_bots_add", style=_BS.SUCCESS if _BS else None)],
        [make_button("➕ ᴀᴅᴅ ᴜsᴇʀ ʙᴏᴛ", callback_data="ak_bots_adduser", style=_BS.SUCCESS if _BS else None)],
...
async def ak_bots_add_callback(client: Client, callback_query: CallbackQuery):
    ...
    await safe_edit(callback_query.message.edit_text, 
        ...
        reply_markup=InlineKeyboardMarkup([
            ...
            [make_button("⚡ ᴀᴅᴅ ᴀᴜᴛᴏ ʙᴏᴛ", callback_data="ak_bots_autocreate", style=_BS.SUCCESS if _BS else None)],
...
def _button_menu_text_and_markup(has_button: bool) -> tuple:
    ...
    if has_button:
        ...
        rows = [[make_button("➕ ᴀᴅᴅ ʙᴜᴛᴛᴏɴ ➕", callback_data="ak_button_add", style=_BS.SUCCESS if _BS else None)]]
