...
def _folder_confirm_kb(session_id: str) -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[
        make_button("✅ ᴅᴏᴡɴʟᴏᴀᴅ ᴀʟʟ", callback_data=f"gofold#{session_id}", style=_BS.PRIMARY if _BS else None),
        make_button("❌ ᴄᴀɴᴄᴇʟ", callback_data=f"gofoldcancel#{session_id}", style=_BS.DANGER if _BS else None),
    ]])
